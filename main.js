function verificadorEra(){
    ...
    if(era.value == 19 || era.value == 21 || era.value ==25 || era.value ==30){
        ...
        document.getElementById("eras").style.fontFamily="'Cinzel', serif"
...
function era19(){
    ...
    let bt = document.getElementById("e")
        ...
        document.getElementById("link").href="https://open.spotify.com/album/59ULskOkBMij4zL8pS7mi0"
...
function era21(){
    ...
    document.getElementById("img").style.borderRadius="500%"
    let bo = document.getElementById("e")
    ...
    let bt = document.getElementById("e")
        ...
        document.getElementById("link").href="https://open.spotify.com/album/0Lg1uZvI312TPqxNWShFXL"
}
...
function era25(){
    ...
    let bt = document.getElementById("e")
        ...
        document.getElementById("link").href="https://open.spotify.com/album/3AvPX1B1HiFROvYjLb5Qwi"
}
...
function era30(){
    ...
    let bt = document.getElementById("e")
        ...
        document.getElementById("link").href="https://open.spotify.com/album/21jF5jlMtzo94wbxmJ18aa"
}
...
function nueva19(){
    ...
    let html = "Tu canción de 19 es " + songs[fraseAle].song 
    document.getElementById("eras").innerHTML=html;
    document.getElementById("eras").style.display="inline"
...
function nueva21(){
    ...
    let html = "Tu canción de 21 es " + songs[fraseAle].song 
    document.getElementById("eras").innerHTML=html
    document.getElementById("eras").style.display="inline"
...
function nueva25(){
    ...
    let fraseAle = Math.round(Math.random() *11)
    let html = "Tu canción de 25 es " + songs[fraseAle].song
    document.getElementById("eras").innerHTML=html
    document.getElementById("eras").style.display="inline"
...
function nueva30(){
    ...
    let fraseAle = Math.round(Math.random() *11)
    let html = "Tu canción de 30 es " + songs[fraseAle].song
    document.getElementById("eras").innerHTML=html
    document.getElementById("eras").style.display="inline"
